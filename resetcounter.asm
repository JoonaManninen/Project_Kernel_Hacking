...
_resetcounter:     file format elf32-i386
  ...
  14:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  22:	8d 7d 8c             	lea    -0x74(%ebp),%edi
  25:	be 80 08 00 00       	mov    $0x880,%esi
	int arg = atoi(argv[1]);
  2a:	e8 61 02 00 00       	call   290 <atoi>
	const char *systemcalls[] = {
  2f:	b9 17 00 00 00       	mov    $0x17,%ecx
  34:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
	int arg = atoi(argv[1]);
  ...
  3b:	e8 6b 03 00 00       	call   3ab <countereset>
  40:	83 c4 10             	add    $0x10,%esp
  43:	83 f8 01             	cmp    $0x1,%eax
  46:	74 47                	je     8f <main+0x8f>
	{
  ...
  60:	5f                   	pop    %edi
  61:	5d                   	pop    %ebp
  62:	8d 61 fc             	lea    -0x4(%ecx),%esp
  65:	c3                   	ret    
		printf(1, "Not enough arguments.\n");
  66:	51                   	push   %ecx
  67:	51                   	push   %ecx
  68:	68 a0 07 00 00       	push   $0x7a0
  6d:	6a 01                	push   $0x1
  6f:	e8 fc 03 00 00       	call   470 <printf>
		exit();
  74:	e8 8a 02 00 00       	call   303 <exit>
		printf(1, "System call %s counter reset\n", systemcalls[arg - 1]);
  79:	50                   	push   %eax
  7a:	ff 74 9d 88          	push   -0x78(%ebp,%ebx,4)
  7e:	68 b7 07 00 00       	push   $0x7b7
  83:	6a 01                	push   $0x1
  ...
  8f:	52                   	push   %edx
  90:	52                   	push   %edx
  91:	68 60 08 00 00       	push   $0x860
  96:	6a 01                	push   $0x1
  98:	e8 d3 03 00 00       	call   470 <printf>
		exit();
  9d:	e8 61 02 00 00       	call   303 <exit>
  a2:	66 90                	xchg   %ax,%ax
  a4:	66 90                	xchg   %ax,%ax
  a6:	66 90                	xchg   %ax,%ax
  a8:	66 90                	xchg   %ax,%ax
 ...
 3cc:	89 d1                	mov    %edx,%ecx
{
 ...
 3f9:	0f b6 92 3c 09 00 00 	movzbl 0x93c(%edx),%edx
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e9:	ff 24 85 e4 08 00 00 	jmp    *0x8e4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba dc 08 00 00       	mov    $0x8dc,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 611:	a1 08 0c 00 00       	mov    0xc08,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 08 0c 00 00    	mov    %edx,0xc08
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 08 0c 00 00    	mov    %edx,0xc08
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d 08 0c 00 00    	mov    0xc08,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d 08 0c 00 00    	mov    0xc08,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 08 0c 00 00    	mov    0xc08,%edx
 ...
 74c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 74f:	89 15 08 0c 00 00    	mov    %edx,0xc08
}
 ...
 75f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 08 0c 00 00 0c 	movl   $0xc0c,0xc08
 767:	0c 00 00 
    base.s.size = 0;
 76a:	bf 0c 0c 00 00       	mov    $0xc0c,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 0c 0c 00 00 0c 	movl   $0xc0c,0xc0c
 776:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 10 0c 00 00 00 	movl   $0x0,0xc10
 782:	00 00 00 
    if(p->s.size >= nunits){
